...
public class DreamEntity extends TamableAnimal {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new TemptGoal(this, 2, Ingredient.of(MeatcraftModItems.CUM_JAR.get()), false));
		this.goalSelector.addGoal(4, new BreedGoal(this, 10));
		this.goalSelector.addGoal(5, new OwnerHurtByTargetGoal(this));
		this.targetSelector.addGoal(6, new OwnerHurtTargetGoal(this));
		this.goalSelector.addGoal(7, new FollowOwnerGoal(this, 10, (float) 10, (float) 2, false));
		this.goalSelector.addGoal(8, new RandomStrollGoal(this, 10));
		...
		this.goalSelector.addGoal(12, new LeapAtTargetGoal(this, (float) 0.3));
		this.goalSelector.addGoal(13, new MeleeAttackGoal(this, 5, true) {
			@Override
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("meatcraft:speedrun"));
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		DreamOnInitialEntitySpawnProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		DreamEntity retval = MeatcraftModEntities.DREAM.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(MeatcraftModItems.CUM_JAR.get()).contains(stack.getItem());
	}
