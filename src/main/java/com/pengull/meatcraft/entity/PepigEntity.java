...
public class PepigEntity extends Pig {
	public PepigEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MeatcraftModEntities.PEPIG.get(), world);
	}

	public PepigEntity(EntityType<PepigEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(MeatcraftModItems.DEFAULTDANCE.get()));
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		CumJarFoodEatenProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
	...
	public static void init() {
		SpawnPlacements.register(MeatcraftModEntities.PEPIG.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
